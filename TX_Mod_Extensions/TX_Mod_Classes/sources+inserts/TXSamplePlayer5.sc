...
//			],
			["Single-Waveform", 
				{arg outRate, bufnumSample, start, end, freq; 
					Osc.ar(bufnumSample, freq, 0);
				}
			],
		],
		// Intonation
...
//invalid		["step", 'step'],
	...
	synthDefFunc = { 
		...
		outSample = outFunction.value(outRate, bufnumSample, sStart, sEnd, outFreqPb) * level * 2;
