...
buildGuiSpecArray {
	...
	if (displayOption == "showActions9-10", {
		...
		["TXPopupAction", "First argument", holdPopupItems, "offsetOSCArgs9", nil, 120],
		["DividingLine"], 
		["TXActionView", arrActions, 9], 
		["NextLine"], 
		["TXCheckBox", "Use OSC arguments for value settings", "useOSCArgs10", nil, 300],
		["TXPopupAction", "First argument", holdPopupItems, "offsetOSCArgs10", nil, 120],
		["DividingLine"], 
		];
	});
}
