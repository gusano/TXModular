...
init {arg argInstName;
	...
	synthDefFunc = { 
		arg out, freq, freqMin, freqMax, change1, change1Min, change1Max, change2, change2Min, change2Max, 
			...
			modFreq = 0, modChange1 = 0, modChange2 = 0, modFreqSelector = 0, modLag = 0, modLag2 = 0;
		var outFreqFunc, outFreq, outFreqLag, outFunction, outChange1, outChange2, lagtime, lagtime2, outLagFunction, outVol;
		...
		Out.ar(out, TXClean.ar(outVol * outFunction.value(outFreqLag, outChange1, outChange2)));
	};
	...
	arrActionSpecs = this.buildActionSpecs([
			...
			["TXStaticText", "Note count", {this.getNoteTotalText}, {arg view; noteListTextView = view;}],			["SynthOptionPopupPlusMinus", "Smoothing", arrOptionData, 2], 
