...
//			["TestNoteVals"], 
	...
	if (displayOption == "showEnv", {
		guiSpecArray = guiSpecArray ++[
			["ActionButton", "Vol Env", {displayOperator = "showVolEnv"; 
				this.buildGuiSpecArray; system.showView;}, 60, 
				TXColor.white, this.getButtonColour(displayOperator == "showAmpEnv")], 
			["Spacer", 3], 
			["ActionButton", "Op 1 Env", {displayOperator = "showOp1"; 
				this.buildGuiSpecArray; system.showView;}, 60, 
				TXColor.white, this.getButtonColour(displayOperator == "showOp1")], 
			["Spacer", 3], 
			["ActionButton", "Op 2 Env", {displayOperator = "showOp2"; 
				this.buildGuiSpecArray; system.showView;}, 60, 
				TXColor.white, this.getButtonColour(displayOperator == "showOp2")], 
			["SpacerLine", 3], 
		];
