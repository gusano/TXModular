...
{arg mod1, mod2, mod3, mod4; 
  SinOsc.kr(0.1 + SinOsc.kr(mod1, 0,mod1), 0, 0.5,0.5); }";
	...
	guiSpecArray = [
		...
		["TextViewDisplay", "Coding Notes: Enter Supercollider 3 code in the window below. The code needs to be a function which returns a control signal. The function will be passed the arguments Modify 1, Modify 2, Modify 3, Modify 4.
