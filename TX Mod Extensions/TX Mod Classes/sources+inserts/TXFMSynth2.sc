...
//		);
		...
		arrFMCtls = [
			...
			[op1FreqRatio * outFreq, op1Phase, op1Amp], 
			[op2FreqRatio * outFreq, op2Phase, op2Amp], 
			[op3FreqRatio * outFreq, op3Phase, op3Amp], 
			[op4FreqRatio * outFreq, op4Phase, op4Amp], 
			[op5FreqRatio * outFreq, op5Phase, op5Amp], 
			[op6FreqRatio * outFreq, op6Phase, op6Amp], 
