...
init {arg argInstName;
	...
	synthDefFunc = { 
		arg out, gate, note, velocity, keytrack, transpose, pitchbend, pitchbendMin, pitchbendMax, modify1, modify1Min, modify1Max, 
			modify2, modify2Min, modify2Max, level, envtime=0, delay, attack, decay, sustain, sustainTime, release, 
			curve, timeMultiply, modPitchbend, modModify1, modModify2, modDelay, modAttack, modDecay, 
			modSustain, modSustainTime, modRelease, modCurve, modTimeMultiply;
		var outEnv, outFreq, trans, pbend, outFunction, outWave, curveAdjusted, 
		...
		outFreq = (note.midicps * keytrack) + (48.midicps * (1-keytrack));
