...
*filterFunction { 
	^ {	arg input, argFilterProcessFunc, freq, freqMin, freqMax, res, resMin, resMax, sat, satMin, satMax, wetDryMix, 
			modfreq, modres, modsat, modWetDryMix;
		...
		(outFilter.tanh * mixCombined) + (input * (1-mixCombined));
	}
}
