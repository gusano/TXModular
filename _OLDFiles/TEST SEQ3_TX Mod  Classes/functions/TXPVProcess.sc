...
Modify 2 - not used.
Modify 3 - not used." ], 
[ "Bin Wipe Down - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
...
Modify 2 - not used.
Modify 3 - not used." ], 
[ "Bin Wipe Up - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
...
[ "Comb Integrater - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
	PV_RectComb(chainA, modify1 * 50, modify2, modify3);}, "Alternates blocks of FFT bins between the main and side chain inputs.
Modify 1 - numTeeth - number of teeth in the comb (0-50).
Modify 2 - phase - starting phase of comb pulse.
Modify 3 - width - pulse width of comb." ], 
[ "Common Magnitudes - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
...
Modify 2 - not used.
Modify 3 - not used." ], 
[ "Magnitude Compare Maximum - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
	PV_Max(chainA, chainB);}, "Compares the main and side chain inputs, and outputs FFT bins with the maximum magnitude.
Modify 1 - not used.
Modify 2 - not used.
Modify 3 - not used." ], 
[ "Magnitude Compare Minimum - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
	PV_Min(chainA, chainB);}, "Compares the main and side chain inputs, and outputs FFT bins with the minimum magnitude.
Modify 1 - not used.
Modify 2 - not used.
Modify 3 - not used." ], 
[ "Magnitude Divide - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
...
Modify 2 - not used.
Modify 3 - not used." ], 
[ "Magnitude Multiply - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
...
Modify 3 - not used." ], 
[ "Multiply Common Magnitudes - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
...
Modify 2 - not used.
Modify 3 - not used." ], 
[ "Random Crossfade - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
...
Modify 2 - shift - add an offset to bin position (range -+128).
Modify 3 - not used." ], 
[ "Soft Wipe - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
...
Modify 2 - not used.
Modify 3 - not used." ], 
[ "Spectral Addition - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
...
Modify 2 - remove - level for uncommon magnitudes (set to 0 to completely remove them).
Modify 3 - not used." ], 
[ "Spectral Morph - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
...
Modify 2 - not used.
Modify 3 - not used." ], 
[ "Spectral Multiply - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
	PV_Mul(chainA, chainB)}, "Complex multiplication of the main and side chain inputs
Modify 1 - not used.
Modify 2 - not used.
Modify 3 - not used." ], 
[ "Spectral Subtraction - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
	PV_MagSubtract(chainA, chainB);}, "Spectral subtraction (difference of magnitudes) - side chain magnitudes are subtracted from main input 
Modify 1 - not used.
Modify 2 - not used.
Modify 3 - not used." ], 
[ "Spectral Subtraction Zero-limited - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
	PV_MagSubtract(chainA, chainB, 1);}, "Spectral subtraction zero-limited (difference of magnitudes) - side chain magnitudes are subtracted from main input. The magnitudes are hard-limited to zero, never going lower. 
Modify 1 - not used.
Modify 2 - not used.
Modify 3 - not used." ], 
[ "Spectral XFade - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
...
Modify 2 - not used.
Modify 3 - not used." ], 
[ "Subtract Magnitudes - uses side chain audio input", {arg chainA, chainB, fftSize, modify1, modify2, modify3; 
