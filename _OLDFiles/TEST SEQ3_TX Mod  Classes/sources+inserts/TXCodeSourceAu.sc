...
{arg mod1, mod2, mod3, mod4; 
  SinOsc.ar(120 + SinOsc.ar(0.3333 + [0,4].asSpec.map(mod1), 
	...
	guiSpecArray = [
		...
		["TextViewDisplay", "Coding Notes: Enter Supercollider 3 code in the window below. The code needs to be a function which returns a mono audio signal. The function will be passed the arguments Modify 1, Modify 2, Modify 3, Modify 4.
