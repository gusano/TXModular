...
TXReverb : TXModuleBase {		
	...
	classvar	<maxDelaytime = 0.1;	//	delay time up to 0.1 secs.
...
init {arg argInstName;
	...
	synthDefFunc = { 
		...
		// combs
		outSound = Mix.arFill(4,{arg i; CombC.ar(input, combdelays.at(i), roomsize * combdelays.at(i),
