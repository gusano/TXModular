...
TXAudioTrigger : TXModuleBase {		// Audio In module 
...
init {arg argInstName;
	...
	guiSpecArray = [
		...
		["SpacerLine", 3], 
		["EZslider", "Threshold", ControlSpec(0.001, 1), "threshold"], 
		...
		["EZslider", "Level", ControlSpec(0.001, 1), "i_level"], 
	];
...
//		[time, responder, msg].postln;
		...
		outVel = this.getSynthArgSpec("i_level") * 127;
