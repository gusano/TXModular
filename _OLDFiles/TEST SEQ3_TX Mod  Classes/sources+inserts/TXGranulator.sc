...
//invalid		["step", 'step'],
	...
	synthDefFunc = { 
		arg out, gate, note, velocity, keytrack, transpose, pitchbend, pitchbendMin, pitchbendMax, 
			bufnumSample, sampleNo, sampleFreq, start, end, pos, randPos, randPitch, randTime, 
...
buildGuiSpecArray {
	...
	if (displayOption == "showSample", {
		guiSpecArray = guiSpecArray ++[
			...
			["ActionButton", "Add Samples to Sample Bank", {TXBankBuilder2.addSampleDialog("Sample")}, 180], 
