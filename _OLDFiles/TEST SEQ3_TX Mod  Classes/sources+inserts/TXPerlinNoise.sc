...
init {arg argInstName;
	...
	synthDefFunc = { arg out, freq1, freq1Min, freq1Max, freq2, freq2Min, freq2Max, 
			freq3, freq3Min, freq3Max, modFreq1 = 0, modFreq2 = 0, modFreq3 = 0;
		var outFreq1, outFreq2, outFreq3, outPerlin3, rangeFunction, outSignal;
//		var outPhasor1, outPhasor2, outPhasor3;
...
//		outPhasor1 = Phasor.kr(0, outFreq1/ControlRate.ir, 0, 1000000);
//		outPhasor2 = Phasor.kr(0, outFreq2/ControlRate.ir, 0, 1000000);
//		outPhasor3 = Phasor.kr(0, outFreq3/ControlRate.ir, 0, 1000000);
//		outPerlin3 = Perlin3.kr(outPhasor1,outPhasor2, outPhasor3);
